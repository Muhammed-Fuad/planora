...
export default function PlanoraAIChatbot() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      // Call your Next.js API route (which will call Claude API)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex relative overflow-hidden">
      ...
      {/* Desktop Sidebar */}
      <aside
        className={`hidden lg:block relative z-50 bg-gray-900/50 backdrop-blur-xl border-r border-purple-500/20 shadow-2xl overflow-hidden transition-all duration-300 ${
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`fixed lg:hidden inset-y-0 left-0 z-50 w-72 bg-gray-900/95 backdrop-blur-xl border-r border-purple-500/20 shadow-2xl transition-transform duration-300 ${
      ...
      <div className="flex-1 flex flex-col min-w-0 relative z-10">
        {/* Header */}
        <div className="bg-gray-900/50 backdrop-blur-xl border-b border-purple-500/20 sticky top-0 z-10">
        ...
        {/* Input Container */}
        <div className="fixed bottom-0 right-0 bg-gray-900/80 backdrop-blur-xl border-t border-purple-500/20 z-20 transition-all duration-300"
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border-2 border-purple-500/30 rounded-xl p-1.5 shadow-2xl shadow-purple-500/20">
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 bg-transparent text-gray-100 placeholder-gray-500 text-sm outline-none resize-none"
                  disabled={isLoading}
                />
                <button
